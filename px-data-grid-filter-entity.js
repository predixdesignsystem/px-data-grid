...
import 'px-slider/px-slider.js';
import 'px-rangepicker/px-rangepicker.js';
import './css/px-data-grid-filter-entity-styles.js';
import { html } from '@polymer/polymer/lib/utils/html-tag.js';
{
   ...
   */
  class DataGridFilterEntityElement extends PolymerElement {
    static get template() {
      return html`
