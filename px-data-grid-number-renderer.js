...
import 'px-number-formatter/px-number-formatter-no-display.js';
import { DataGridRendererMixin } from './px-data-grid-renderer-mixin.js';
import './px-data-grid-theme.js';
import './css/px-data-grid-number-renderer-styles.js';
import { html } from '@polymer/polymer/lib/utils/html-tag.js';
{
   ...
   */
  class DataGridNumberRenderer extends DataGridRendererMixin(PolymerElement) {
    static get template() {
      return html`
