...
$_documentContainer.innerHTML = `<dom-module id="px-data-grid-theme" theme-for="vaadin-grid">
  <template>
    <style>
      :host {
      ...
      [part~="row"]:hover [part~="body-cell"][hidden-unless-hover] ::slotted(vaadin-grid-cell-content),
      [part~="row"] [part~="body-cell"][hidden-unless-hover]:focus ::slotted(vaadin-grid-cell-content),
      [part~="row"] [part~="body-cell"][hidden-unless-hover]:active ::slotted(vaadin-grid-cell-content),
      .safari-hover [part~="body-cell"][hidden-unless-hover] ::slotted(vaadin-grid-cell-content) {
        visibility: visible;
      }
    </style>
  </template>
</dom-module><dom-module id="vaadin-grid-tree-toggle-theme" theme-for="vaadin-grid-tree-toggle">
  <template>
    <style>
      :host {
        display: flex;
